...
public class DistanceBeaconActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
      ...
      findViewById(R.id.buttonAddImage).setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View v) {
              Intent intent = new Intent(DistanceBeaconActivity.this, CardViewActivity.class);
