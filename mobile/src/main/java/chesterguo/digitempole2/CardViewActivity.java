...
public class CardViewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.newPost).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CardViewActivity.this, InputViewActivity.class);
                //todo should add extra data for store in right node
    ...
    public void showPrevPost (View view){
        System.out.println("Heyy, Previous");
    }

    public void showNextPost (View view){
        System.out.println("Heyy, Next");
    }
}
