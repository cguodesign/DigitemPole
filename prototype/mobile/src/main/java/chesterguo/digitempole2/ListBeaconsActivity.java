...
public class ListBeaconsActivity extends Activity {
      ...
      public void onBeaconsDiscovered(Region region, final List<Beacon> beacons) {
        ...
        runOnUiThread(new Runnable() {
          ...
          public void run() {
            ...
            getActionBar().setSubtitle("Found digitem poles: " + beacons.size());
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    // Function to connect beacons to the survices
    // Todo: change the action bar to the progressive images
  private void connectToService() {
    ...
    // This is what will happen if we click on each beacon.
    // which send the infomation of specific beacon to the next page.
